...
<template>
    ...
    <div class="w-full h-auto p-4  dark:text-white flex flex-row-reverse flex-wrap-reverse items-center justify-center gap-4">
        <div :class="{ concluido: chamado.concluido }" v-for="(chamado, index) in chamados.register" :key="index"
            ...
            <button @click="chamado.concluido = false" v-if="chamado.concluido"
            ...
            <button v-if="!chamado.concluido" @click="chamados.marcarConcluido(index)"
            ...
            <button v-if="!chamado.concluido" @click="chamados.removerChamado(index)"
            ...
            <button v-if="!chamado.concluido" @click="abrirEditor(index), openModal()"
            ...
            <button v-if="!chamado.concluido" @click="chamados.copiarConteudo(chamado)"
